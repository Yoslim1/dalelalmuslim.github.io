...
const styles = StyleSheet.create({
  ...
  surface: { backgroundColor: palette.surface, borderColor: palette.outlineVariant, borderRadius: 24, borderWidth: 1, shadowColor: palette.shadow, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 1 },
  ...
  button: { alignItems: "center", borderRadius: 24, flexDirection: "row", gap: 8, justifyContent: "center", minHeight: 48, paddingHorizontal: 20 },
